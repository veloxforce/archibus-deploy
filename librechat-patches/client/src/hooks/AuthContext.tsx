...
const AuthContextProvider = ({
  ...
  /** One success/error path for every way in: password login and the Bruce token door. */
  ...
  const loginUser = useLoginUserMutation(loginMutationOptions);
  const bruceLoginUser = useBruceLoginMutation(loginMutationOptions);
  ...
  const bruceLogin = (userToken: string) => {
    bruceLoginUser.mutate(userToken);
  };
