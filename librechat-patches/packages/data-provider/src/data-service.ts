...
/** Bruce token door: exchange a Bruce user token for a session (see /api/auth/bruce). */
export const bruceLogin = (userToken: string): Promise<t.TLoginResponse> => {
  return request.post(endpoints.bruceLogin(), { userToken });
};
